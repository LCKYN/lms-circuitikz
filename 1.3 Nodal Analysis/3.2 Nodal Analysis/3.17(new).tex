...
\begin{circuitikz}[american voltages]
    ...
    \draw(0,3) node[circ, color=purple]{} node[anchor=south west,color=purple] {$v_2$};
    \draw(3,3) node[circ, color=purple]{} node[anchor=south west,color=purple] {$v_3$};
    \draw(3,6) node[circ, color=purple]{} node[anchor=south west,color=purple] {$v_1$};

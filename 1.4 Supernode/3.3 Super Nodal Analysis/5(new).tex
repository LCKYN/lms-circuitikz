...
\begin{circuitikz}[american voltages]
    ...
    \draw (0,0) to[R, l=$R_1$] ++(0,3) to[short,-] ++(0,1.5);
    \draw (3,3) to[R, l_=$R_3$, v^=$v_o$] ++(0,-3);
    \draw (6,0) to[R, l=$R_4$] ++(0,3) to[short,-] ++(0,1.5);
    
    % y
    \draw (-2,0) to[short,-*] ++(2,0) to[short,-*] ++(3,0) node[ground]{} to[short] ++(3,0);
    \draw (6,3) to[american current source,l_=$I_{S2}$] ++(-3,0) to[R,l_=$R_2$] ++(-3,0) to[short] ++(-2,0);

...
\begin{circuitikz}[american,cute inductors]
    ...
    \draw(0,0)
        to[V,l=\vsname{}] ++(0,5)
        to[R,l=\rname{1}] ++(3,0) node[op amp, noinv input down, anchor=+](oa){}
        (oa.-) to[short] ++(0,1.5) coordinate(temp)
        to[short] (oa.out |- temp)
        to[short,-*] (oa.out)
        to[R,l=\rname{2},*-*] ++(3,0) node[op amp, noinv input down, anchor=-](oa2){}
        (oa2.-) to[short] ++(0,1.5) coordinate(temp2)
        to[R,l=\rname{3}] (oa2.out |- temp2)
        to[short,-*] (oa2.out)
        (oa2.+) to[short,-*] (oa2.+ |- 0,0) (oa2.out) 
        to[R,l=\rname{4}] ++(3,0) node[op amp, noinv input up, anchor=+](oa3){}
        (oa3.-) to[short] ++(0,-1.5) coordinate(temp3)
        to[R,l=\rname{6}] (oa3.out |- temp3)
        to[short,-*] (oa3.out) (temp3)
        to[R,l_=\rname{5},*-*] (temp3 |- 0,0) (oa3.out)
